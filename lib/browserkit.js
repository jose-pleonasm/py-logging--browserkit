...
function install(logging) {
	 ...
	 */
	WebSocketClient.prototype.addHandler = function(handler) {
	 ...
	 * @param {Handler} handler
	 */
	WebSocketClient.prototype.removeHandler = function(handler) {
	...
	WebSocketClient.prototype._handle = function(message) {
		...
		this._handlers.forEach(function handle(handler) {
